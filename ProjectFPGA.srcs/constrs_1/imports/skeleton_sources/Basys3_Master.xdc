...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {LED_DEBUG}]					
...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {ADC_IN_P2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ADC_IN_P2}]
##Sch name = JA2
...
##Sch name = JA7
#set_property PACKAGE_PIN H1 [get_ports {ADC_IN_N2}]					
...
##Sch name = XA2_P
#set_property PACKAGE_PIN L3 [get_ports {ADC_IN_P2}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {ADC_IN_P2}]
##Sch name = XA3_P
...
set_property PACKAGE_PIN K3 [get_ports {ADC_IN_N}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {ADC_IN_N}]
##Sch name = XA2_N
#set_property PACKAGE_PIN M3 [get_ports {ADC_IN_N2}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {ADC_IN_N2}]
##Sch name = XA3_N
